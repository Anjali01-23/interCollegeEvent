...
import NewReq from "../components/anotherparticipants/NewReq";
import AdminData from "../components/anotherparticipants/AdminData";

const AdminParticipantDashboard = () => {
  const location = useLocation();
  const params = new URLSearchParams(location.search);
  const defaultTab = params.get("tab") || "New Requests";
  const [activeTab, setActiveTab] = useState(defaultTab);

  const tabs = ["New Requests", "All Requests"];
...
export default AdminParticipantDashboard;
